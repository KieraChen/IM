...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;订货&nbsp;>&nbsp;手工订货</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">商品组名称</th>
        <th align="center" valign="middle" class="borderright">单位名称</th>
        <th align="center" valign="middle" class="borderright">保质期</th>
          <th align="center" valign="middle" class="borderright">最小订数量</th>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${i.IM_szArticleType}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szPriceUnitOfMeasureName }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.IM_lShelfLife }</td>
        <td align="center" valign="middle" class="borderbottom">${i.IM_dMinOrderQty }</td>
        <td align="center" valign="middle" class="borderbottom">12</td>
