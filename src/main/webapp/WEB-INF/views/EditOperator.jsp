...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;系统管理&nbsp;>&nbsp;用户管理&nbsp;>&nbsp;编辑用户</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <c:if test="${empty map || !map.containsKey('userName')}">
           <input class="text-word" type='text' name='userName' value='1' id='userName'/><span id="msg"></span>
        </c:if>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <c:if test="${empty map || !map.containsKey('userPwd')}">
           <input class="text-word" type='password' name='userPwd' value='1'/>
        </c:if>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <c:if test="${empty map || !map.containsKey('userCode')}">
           <input class="text-word" type='text' name='userCode' value='1'/>
        </c:if>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <c:if test="${empty map || !map.containsKey('userAge')}">
           <input class="text-word" type='text' name='userAge' value='23'/>
        </c:if>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
