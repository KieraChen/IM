...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;收货&nbsp;>&nbsp;收货单详情</td>
  </tr>
  <tr>
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">货架位置</th>
          <th align="center" valign="middle" class="borderright">订单数量</th>
          <th align="center" valign="middle" class="borderright">售价</th>
          <th align="center" valign="middle" class="borderright">单位名称</th>

          <th align="center" valign="middle" class="borderright">实收数</th>
          <th align="center" valign="middle" class="borderright">破损数量</th>
          <th align="center" valign="middle" class="borderright">破损原因</th>
        ...
        <td align="center" valign="middle" class="borderbottom">${i.dOrderQty }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dPackingUnitPriceAmount }</td>
        <td align="center" valign="middle" class="borderbottom">${i.szPriceUnitOfMeasureName }</td>

        <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
        <td align="center" valign="middle" class="borderbottom"><input type='text' value='${i.dRvrActualQty }'/></td>
        <td align="center" valign="middle" class="borderbottom"><input type='text' value='${i.dLossQty }'/></td>
        <td align="center" valign="middle" class="borderbottom"><input type='text' value='${i.szReasonCode }'/></td>
