...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;门店调拨</td>
    </tr>
</table>
...
<div id="app">
    <el-container>
      ...
      <span class="el-dropdown-link" align = "center">
        请选择门店<i class="el-icon-arrow-down el-icon--right"></i>
      </span>
                        <el-dropdown-menu slot="dropdown">
                            <a href="${pageContext.request.contextPath}/transfer/transferFirst.do"><el-dropdown-item >801 RetailStore 801</el-dropdown-item></a>
                            <a href="${pageContext.request.contextPath}/transfer/transferSecond.do"><el-dropdown-item >802 测试门店</el-dropdown-item></a>
                            <el-dropdown-item >803 test door</el-dropdown-item>
                            <el-dropdown-item >804 simple door</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
            </el-row>
