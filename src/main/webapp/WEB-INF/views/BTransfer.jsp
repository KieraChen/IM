...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;报表查询&nbsp;>&nbsp;调拨清单</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/transfer/bTransfer.do">
                ...
                调拨单：<input type='text' name='szDocumentNmbr' value='${detail.szDocumentNmbr}'/>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
       ...
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">调拨单号</th>
        ...
        <th align="center" valign="middle" class="borderright">调拨数量</th>
        <th align="center" valign="middle" class="borderright">调拨原因</th>
