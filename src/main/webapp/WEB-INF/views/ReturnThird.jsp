...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;退货&nbsp;>&nbsp;退货申请</td>
  </tr>
  <tr>
  ...
  <tr>
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">库存</th>
          ...
          <th align="center" valign="middle" class="borderright">退货数</th>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">230</td>
        ...
        <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
        <td align="center" valign="middle" class="borderbottom"><input type='text' value='10'/></td>
    ...
    <tr>
        <form action="${pageContext.request.contextPath}/return/returnFourth.do">
