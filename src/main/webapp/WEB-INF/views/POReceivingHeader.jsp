...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;收货</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">发票号</th>
        <th align="center" valign="middle" class="borderright">直送单号</th>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${i.lRetailStoreID }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szDocumentNmbr }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szVendorID }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szInvoiceNmbr }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szDSDReceiptNmbr }</td>

        <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
        <td align="center" valign="middle" class="borderbottom">
        <a href="${pageContext.request.contextPath}/poReceiving/poReceivingDetail.do?szDocumentNmbr=${i.szDocumentNmbr }" target="mainFrame" onFocus="this.blur()" class="add">收货</a></td>
    <%--</c:if>--%>
     </tr>
     </c:forEach>
