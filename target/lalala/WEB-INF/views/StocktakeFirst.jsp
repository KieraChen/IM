...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;盘点</td>
  </tr>
    <tr>
        <td width="99%" align="left" valign="top">盘点单</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
          ...
          <th align="center" valign="middle" class="borderright">盘点</th>
        ...
        <%-- <td align="center" valign="middle" class="borderright borderbottom">${u.id }</td> --%>
            ...
            <td align="center" valign="middle" class="borderright borderbottom">${i.szStartTime}</td>
...
<form action="${pageContext.request.contextPath}/stocktake/stocktakeSecond.do" method="post">
                <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
            <td align="center" valign="middle" class="borderbottom"><input type='submit' value='盘点'/></td>
</form>
    <%--</c:if>--%>
     </tr>
     </c:forEach>
