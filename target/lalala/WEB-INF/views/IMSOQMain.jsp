...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;订货</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
         ...
         <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
  		  ...
  		  <a href='${pageContext.request.contextPath}/order/addIMOrder.do' target="mainFrame" onFocus="this.blur()" class="add">手工订货</a></td>
  		 <%--</c:if>--%>
  		</tr>
	</table>
    </td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">往上四周销量</th>
        <th align="center" valign="middle" class="borderright">货架位置</th>
          <th align="center" valign="middle" class="borderright">安全库存</th>
          <th align="center" valign="middle" class="borderright">库存</th>
          <th align="center" valign="middle" class="borderright">最小订货数</th>
          <th align="center" valign="middle" class="borderright">箱规</th>
          <th align="center" valign="middle" class="borderright">建议订货数数</th>

          <th align="center" valign="middle" class="borderright">订货数</th>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${i.szDate }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szPOSItemID }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szDescription }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.dWk4 }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${i.szItemShelfLoc }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dSafetyMinQty }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dInventory }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dItemMOQ }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dItemLDU }</td>
        <td align="center" valign="middle" class="borderbottom">${i.dSOQ }</td>

        <%--<c:if test="${sessionScope.operator.szPower==1 }">--%>
        <td align="center" valign="middle" class="borderbottom"><input type='text' value='${i.dRevisedSOQ }'/></td>
  ...
  <tr><td align="center">
    <c:if test="${pageInfo.pageNum > 1}">
      <a href="${pageContext.request.contextPath}/order/imSOQ.do?pn=1">首页</a>
      <a href="${pageContext.request.contextPath}/order/imSOQ.do?pn=${(pageInfo.pageNum - 1)}">&laquo;</a>
    </c:if>
    <c:forEach begin="1" end="${pageInfo.pages}" step="1" var="no">
        <a href="${pageContext.request.contextPath}/order/imSOQ.do?pn=${no}">${no}</a>
    </c:forEach>
    <c:if test="${pageInfo.pageNum < pageInfo.pages }">
      <a href="${pageContext.request.contextPath}/order/imSOQ.do?pn=${(pageInfo.pageNum + 1)}">&raquo;</a>
      <a href="${pageContext.request.contextPath}/order/imSOQ.do?pn=${pageInfo.pages}">尾页</a>
    </c:if>


<%--跳转 --%>

    <form method='post' action='${pageContext.request.contextPath}/order/imSOQ.do' style=" display:inline-block">
