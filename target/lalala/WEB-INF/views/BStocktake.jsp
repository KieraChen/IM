...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;报表查询&nbsp;>&nbsp;盘点清单</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/stocktake/bStocktake.do">
                ...
                盘点单：<input type='text' name='szDocumentNmbr' value='${detail.szDocumentNmbr}'/>
       ...
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${i.szPosItemID}</td>
          ...
          <td align="center" valign="middle" class="borderright borderbottom">${i.dPackingUnitPriceAmount }</td>
            ...
            <td align="center" valign="middle" class="borderright borderbottom">${i.szGondolaStorageLocationName }</td>
