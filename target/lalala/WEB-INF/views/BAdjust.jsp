...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;报表查询&nbsp;>&nbsp;库存调整清单</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/adjust/bAdjust.do">
                ...
                库存调整单：<input type='text' name='szDocumentNmbr' value='${detail.szDocumentNmbr}'/>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
       ...
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
        ...
        <th align="center" valign="middle" class="borderright">库存调整单号</th>
        ...
        <th align="center" valign="middle" class="borderright">价格</th>
          <th align="center" valign="middle" class="borderright">单位</th>
        <th align="center" valign="middle" class="borderright">仓库</th>
        <th align="center" valign="middle" class="borderright">调整数量</th>
        <th align="center" valign="middle" class="borderright">调整原因</th>
