...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;退货</td>
    </tr>
</table>
...
<div id="app">
    <el-container>
        ...
        <el-main>
            <form action="${pageContext.request.contextPath}/return/returnSecond.do" method="post">
                <div align="center" valign="middle">
            <el-button type="primary" native-type = “submit”>有实物</el-button>
            <el-button type="primary" native-type = “submit”>无实物</el-button>
                </div>
            </form>
        </el-main>
    </el-container>
