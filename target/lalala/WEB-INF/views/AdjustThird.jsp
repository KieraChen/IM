...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置:&nbsp;业务管理&nbsp;>&nbsp;库存调整&nbsp;>&nbsp;添加库存调整商品数量</td>
  </tr>
    <tr>
        <td width="99%" align="left" valign="top">调整原因：&nbsp;&nbsp;残损</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <%--</c:if>--%>
       <!--  <th align="center" valign="middle" class="borderright">id</th> -->
          ...
          <th align="center" valign="middle" class="borderright">调整数</th>
